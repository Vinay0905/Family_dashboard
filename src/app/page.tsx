    ...
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground font-sans">
      ...
      <header className="relative z-10 border-b border-border bg-card/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="flex h-10 w-10 items-center justify-center rounded bg-primary text-primary-foreground shadow-md">
          ...
          <div className="flex items-center gap-6">
            ...
            <Button asChild className="bg-primary hover:bg-primary/95 text-primary-foreground font-bold transition-all px-4 rounded h-9">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-20 pb-24 sm:pt-28 sm:pb-32">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Heading */}
          <h1 className="mt-8 max-w-4xl font-heading text-5xl font-black tracking-tight text-foreground sm:text-7xl/tight">
            The private organizer for your{" "}
            <span className="text-primary italic">entire family</span>
          </h1>

          {/* Subtitle */}
          <p className="mt-6 max-w-2xl font-sans text-base text-muted-foreground font-medium sm:text-lg">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/95 text-primary-foreground px-8 h-12 shadow-lg shadow-primary/15 font-bold transition-all rounded">
              <Link href="/signup" className="flex items-center gap-2">
                Get Started For Free
                <ArrowRight className="h-4 w-4" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-border text-foreground hover:bg-accent h-12 px-8 font-bold transition-all rounded bg-card">
        ...
        <div className="mt-28 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="glass-card p-6 rounded shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="mt-4 font-heading text-xl font-bold text-foreground">Family Calendar</h3>
              <p className="mt-2 font-sans text-xs text-muted-foreground font-medium leading-relaxed">
          ...
          <div className="glass-card p-6 rounded shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="mt-4 font-heading text-xl font-bold text-foreground">Shared Tasks</h3>
              <p className="mt-2 font-sans text-xs text-muted-foreground font-medium leading-relaxed">
          ...
          <div className="glass-card p-6 rounded shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="mt-4 font-heading text-xl font-bold text-foreground">Shopping Lists</h3>
              <p className="mt-2 font-sans text-xs text-muted-foreground font-medium leading-relaxed">
          ...
          <div className="glass-card p-6 rounded shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="mt-4 font-heading text-xl font-bold text-foreground">Expense Tracker</h3>
              <p className="mt-2 font-sans text-xs text-muted-foreground font-medium leading-relaxed">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-border bg-card/50 py-8 text-center text-xs font-bold text-muted-foreground">
