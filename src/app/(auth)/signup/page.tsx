...
import { Heart, ShieldCheck, Mail, Lock, User, Eye, EyeOff } from "lucide-react";
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (data.session) {
        ...
        setMessage("Verification email sent! Please check your inbox (including spam) to confirm your email.");
      }
    } catch (err: any) {
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 font-sans text-sm text-on-surface-variant font-medium">
            Start organizing calendars, tasks, and lists for your home
          </p>
        </div>
        ...
        <div className="mt-8 glass-card p-8 rounded-2xl shadow-xl">
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            {message ? (
              <div className="rounded border border-secondary-container/20 bg-secondary-container/5 p-3 text-sm text-secondary flex items-start gap-2 font-medium">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="absolute top-2.5 left-3 h-4 w-4 text-on-surface-variant" />
                <Input
                  id="displayName"
                  type="text"
